...
class Socket_comm():
    def __init__(self):
        ...
        self.server_address = (('192.168.1.6', self.PORT_NUM))        # Controller IP address
    ...
    def move_robot(self, move_coord, move_mode):        #Move I-K linear
    ...
    def moveposition(self, pos):
        ...
        self.move_robot(pos, self.MACHINE_ABS_LINEAR)
        self.tool_coordinate()
        print("Done")
if __name__=="__main__":
    
    InitSock = Socket_comm()
    
    InitSock.socket_initalize()
    InitSock.joint_coordinate()
    InitSock.tool_coordinate()
    
    home_pos = [390, 0, 567, -1.5, 0, 0]
    InitSock.moveposition(home_pos)
    
    pos = [150, -480, 420, 0, 0, 0]
    InitSock.moveposition(pos)
