...
def StartOpenAI_ROS_Environment(task_and_robot_environment_name, max_step):
    """
    ...
    result = RegisterOpenAI_Ros_Env(
        task_env=task_and_robot_environment_name, max_episode_steps=max_step
    )
    ...
    if result:
        ...
        env = gym.make(task_and_robot_environment_name)  # entry point
    else:
